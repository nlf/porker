...
class Porker extends EventEmitter {
    constructor({ connection, queue, errorThreshold = 1, retryDelay = '5 minutes', timeout = 15000, concurrency = 1 } = {}) {
    ...
    async subscribe(fn) {
        ...
        this[Symbols.fn] = internals.wrapSubscriber(fn);
        this[Symbols.loop]();
    }
    ...
    async retry(fn) {
        ...
        this[Symbols.retry] = internals.wrapSubscriber(fn);
        this[Symbols.retryLoop]();
    }
