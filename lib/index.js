...
class Porker extends EventEmitter {
    ...
    async drop() {
        ...
        const client = await this[Symbols.client].connect();
        await this[Symbols.client].query(this.#queries.dropTable);
        client.release();
    }
    ...
    async subscribe(fn) {
        ...
        await this[Symbols.workerListener].query(this.#queries.listenPublishes);
    ...
    async retry(fn) {
        ...
        await this[Symbols.retryListener].query(this.#queries.listenRetries);
